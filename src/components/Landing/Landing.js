    ...
    <div>
      <div className="intro-container">
        ...
        <div className="rectangle">
          ...
          <h2>
            Streamline your transactions with our range of custom-designed
            receipt layouts, tailored to enhance your brand and optimize your
      ...
      <div className="services-container">
        ...
        <p>
          {" "}
          A commercial printing service provider in the Philippines.
          <br />
          Printing your requirements is now easier than ever. Here’s how it
          works:
        </p>
        <p>
          {" "}
